...
-- IDs asignados para coincidir con 003_data.sql
-- Proyecto Sierra Alta
INSERT INTO contratos (id, proyecto_id, servicio_id, empresa_id, tipo_turnos, patron, activo, fecha_inicio) VALUES
(1, 1, 2, 2, 'ABCD', '7x7', TRUE, '2024-01-01'),   -- ID 1: Perforaciones Andinas
(2, 1, 3, 3, 'ABCD', '7x7', TRUE, '2024-01-01'),   -- ID 2: Servicios Campamento
(3, 1, 5, 5, 'AB', '5x2', TRUE, '2024-01-01'),     -- ID 3: Logistica Minera
(8, 1, 4, 4, 'ABCD', '7x7', TRUE, '2024-01-01');   -- ID 8: Sondajes del Norte

-- Proyecto Valle Verde
INSERT INTO contratos (id, proyecto_id, servicio_id, empresa_id, tipo_turnos, patron, activo, fecha_inicio) VALUES
(4, 2, 2, 2, 'ABCD', '10x10', TRUE, '2024-03-01'), -- ID 4: Perforaciones Andinas
(5, 2, 4, 4, 'ABCD', '7x7', TRUE, '2024-03-01');   -- ID 5: Sondajes del Norte

-- Proyecto Salar Blanco
INSERT INTO contratos (id, proyecto_id, servicio_id, empresa_id, tipo_turnos, patron, activo, fecha_inicio) VALUES
(6, 3, 2, 2, 'ABCD', '14x14', TRUE, '2024-06-01'), -- ID 6: Perforaciones Andinas
(7, 3, 3, 3, 'ABCD', '14x14', TRUE, '2024-06-01'); -- ID 7: Servicios Campamento

-- Proyecto Cerro Rojo
INSERT INTO contratos (id, proyecto_id, servicio_id, empresa_id, tipo_turnos, patron, activo, fecha_inicio) VALUES
(9, 4, 2, 2, 'ABCD', '7x7', TRUE, '2023-01-01');   -- ID 9: Perforaciones Andinas
